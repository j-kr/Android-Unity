package com.example.jakub.memorygame;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void koniec()
    {
                ...
                iv28.getVisibility() == View.INVISIBLE )
        {
            ...
            aleBuilder
                    .setMessage("Brawo! Następny poziom.")
                    .setCancelable(false)
    ...
    private void koniecpkt()
    {
        if(prob<=0)
        {
            AlertDialog.Builder aleBuilder = new AlertDialog.Builder(MainActivity.this);
            aleBuilder
                    .setMessage("Przegrałeś. Wykorzystałeś wszystkie szanse")
                    .setCancelable(false)
